...
public class FileMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(dirObj.isDirectory() ? "디렉토리입니다.":"디렉토리가아닙니다.");
		dirObj.mkdirs();
		System.out.println(dirObj.isDirectory() ? "디렉토리입니다.":"디렉토리가아닙니다.");
		*/
		...
		/*
		System.out.println(fileObj.exists() ? "존재합니다.":"잘못된이름입니다.");
		System.out.println(fileObj.isFile() ? "파일입니다.":"파일이아닙니다.");
		System.out.println(fileObj.isDirectory() ? "디렉토리입니다.":"디렉토리가아닙니다.");
